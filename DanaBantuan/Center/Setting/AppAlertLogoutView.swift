...
class AppAlertLogoutView: UIView {
    ...
    lazy var bgImageView: UIImageView = {
        ...
        bgImageView.image = languageCode == .id ? UIImage(named: "id_out_app_imge") : UIImage(named: "en_out_app_imge")
